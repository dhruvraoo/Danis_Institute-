...
export default function StudentLife() {
  ...
  const heroSlides = [
    {
      image: "https://images.unsplash.com/photo-1503676382389-4809596d5290?w=1200&h=600&fit=crop", // Example vibrant campus image
      title: "Student Life",
      description: "Experience vibrant campus life with numerous clubs, activities, and opportunities for growth.",
    },
  ];
        ...
        <section className="py-16 bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 gap-6 md:grid-cols-4 mb-12">
              {[
                { icon: Users, label: "Student Clubs" },
                ...
                >
                  <item.icon className="h-8 w-8 text-blue-600 dark:text-blue-400 mx-auto mb-3" />
                  <div className="text-gray-900 dark:text-white font-medium text-center">
                    {item.label}
                  </div>
                </motion.div>
              ))}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-blue-100 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Discover the exciting world of student life at DIS with
                comprehensive information about clubs, events, facilities, and
                student support services coming soon.
              </p>
            </div>
          </div>
        </section>
